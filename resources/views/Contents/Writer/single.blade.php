...
@section("title", "Kitap - ".$writer->name)
@section("content")
    ...
    <div class="accordion" id="accordionExample" >
        <div class="accordion-item" style="background-color:#191a1f; color:white; border:none;">
            <div id="collapse1" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <form action="{{route('writer.islem.Inceleme')}}" method="POST"> @csrf
                    ...
                    @foreach($writerData['reviews'] as $reviews)
        ...
        <div class="accordion-item" style="background-color:#191a1f; color:white; border:none;">
            <div id="collapse2" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <form action="{{route('writer.islem.Alinti')}}" method="POST"> @csrf
                    ...
                    @foreach($writerData['quotes'] as $quotes)
