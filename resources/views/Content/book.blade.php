    ...
    <div class="card-body text-white">
        <form method="POST" action="{{route('content.book.add')}}" enctype="multipart/form-data"> @csrf
            <input type="hidden" name="process" value="publicInfo">
                ...
                <div class="form-group">
                    <label>Konusu</label>
                    <textarea name="about" placeholder="Kitabın özeti" rows="10" class="form-control" style="background-color:dimgray;" required></textarea>
                </div><br>
                <div class="form-group">
                    <label>Türü</label>
                ...
                <div class="form-group">
                    ...
                    <input name="page" placeholder="Kitabın sayfa sayısı" type="text" class="form-control" style="background-color:dimgray;" required>
                </div><br>
                <div class="form-group">
            ...
            <button type="submit" class="btn btn-success w-100">Kitabı Ekle</button>
        </form>
    </div>
</div>
