        ...
        <form method="POST" action="{{route('content.book.add')}}" enctype="multipart/form-data"> @csrf
            <input type="hidden" name="process" value="publicInfo">
                <div class="form-group">
                    <label>Adı</label>
                    <input name="name" placeholder="Filmin adı" type="text" class="form-control" style="background-color:dimgray;" required>
                </div><br>
                <div class="form-group">
                    <label>Konusu</label>
                    <textarea name="about" placeholder="Filmin özeti" rows="10" class="form-control" style="background-color:dimgray;" required></textarea>
                </div><br>
                <div class="form-group">
                    <label>Türü</label>
                ...
                <div class="form-group">
                    ...
                    <input name="page" placeholder="Filmin sayfa sayısı" type="text" class="form-control" style="background-color:dimgray;" required>
                </div><br>
                <div class="form-group">
                    <label>Çıkış Yılı</label>
                    <input name="releaseYear" placeholder="Filmin " type="date" class="form-control" style="background-color:dimgray;" required>
                </div><br>
                <div class="form-group">
                    <label>Yönetmeni</label>
                    <input name="writer" placeholder="Filmin yazarı" type="text" class="form-control" style="background-color:dimgray;" required>
                </div><br>
                <div class="form-group">
